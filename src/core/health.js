...
// src/core/health.js -> repo root. The update check must run git HERE, not in
// process.cwd() — an MCP server inherits the client's working directory, which
// is the user's own project. Without cwd, that unrelated repo's slug would be
// sent to api.github.com and its SHA returned as ours.
